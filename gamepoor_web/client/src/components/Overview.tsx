...
import '../styles/overview.css'; // 스타일 파일이 필요한 경우 추가하세요.
  ...
  return (
    <div className="overview-container">
      ...
      <p className="overview-content">
        "몬스터 킬러"는 플레이어가 다양한 몬스터를 사냥하고 경쟁하는 액션 RPG 게임입니다. 
        이 게임은 전략적인 전투와 다채로운 퀘스트를 통해 플레이어에게 몰입감을 제공합니다.
      </p>
      ...
      <p className="overview-footer">
        "몬스터 킬러"는 플레이어가 새로운 경험을 통해 게임의 재미를 극대화할 수 있도록 설계되었습니다.
      </p>
    </div>
  );
};
